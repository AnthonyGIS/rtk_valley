...
import com.weng.rtkvalley.ui.demo_pickview.bean.CardBean;
import com.weng.rtkvalley.ui.demo_pickview.bean.ProvinceBean;
...
@SuppressWarnings({"FieldMayBeFinal", "rawtypes", "JavaDoc"})
public class PickViewMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_pick_view);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_Time && pvTime != null) {
            ...
            startActivity(new Intent(PickViewMainActivity.this, JsonDataActivity.class));
        } else if (v.getId() == R.id.btn_fragment) {//跳转到 fragment
            startActivity(new Intent(PickViewMainActivity.this, FragmentTestActivity.class));
        } else if (v.getId() == R.id.btn_lunar) {
            pvCustomLunar.show();
        } else if (v.getId() == R.id.btn_circle) {
            startActivity(new Intent(PickViewMainActivity.this, TestCircleWheelViewActivity.class));
        }
    }
    ...
    private void initLunarPicker() {
        ...
        pvCustomLunar = new TimePickerBuilder(this, new OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {//选中事件回调
                Toast.makeText(PickViewMainActivity.this, getTime(date), Toast.LENGTH_SHORT).show();
            }
        })
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                .setOptionsSelectChangeListener(new OnOptionsSelectChangeListener() {
                    ...
                    public void onOptionsSelectChanged(int options1, int options2, int options3) {
                        ...
                        Toast.makeText(PickViewMainActivity.this, str, Toast.LENGTH_SHORT).show();
                    }
                })
                .build();
